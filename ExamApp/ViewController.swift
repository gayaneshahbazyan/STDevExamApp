...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIActionSheetDelegate {
    ...
    var urlTblView: UITableView!
    var addUrlBtn: UIButton!
    ...
    override func viewDidLoad() {
        ...
        urlTblView = UITableView()
        urlTblView.delegate = self
        urlTblView.dataSource = self
        urlTblView.translatesAutoresizingMaskIntoConstraints = false
        urlTblView.register(URLTableViewCell.self, forCellReuseIdentifier: "cell")
        self.view.addSubview(urlTblView)
        self.view.addConstraint(NSLayoutConstraint.init(item: urlTblView, attribute: .top, relatedBy: .equal, toItem: self.topLayoutGuide, attribute: .bottom, multiplier: 1.0, constant: 0))
        self.view.addConstraint(NSLayoutConstraint.init(item: urlTblView, attribute: .trailing, relatedBy: .equal, toItem: self.view, attribute: .trailing, multiplier: 1.0, constant: 0))
        self.view.addConstraint(NSLayoutConstraint.init(item: urlTblView, attribute: .leading, relatedBy: .equal, toItem: self.view, attribute: .leading, multiplier: 1.0, constant: 0))
        self.view.addConstraint(NSLayoutConstraint.init(item: urlTblView, attribute: .bottom, relatedBy: .equal, toItem: self.view, attribute: .bottom, multiplier: 1.0, constant: -60))
        
        // button for adding new URLs
        addUrlBtn = UIButton()
        addUrlBtn.translatesAutoresizingMaskIntoConstraints = false
        addUrlBtn.setImage(UIImage(named: "add"), for: .normal)
        addUrlBtn.addTarget(self, action: #selector(addNewURL), for: .touchUpInside)
        self.view.addSubview(addUrlBtn)
        
        self.view.addConstraint(NSLayoutConstraint(item: addUrlBtn, attribute: .trailing, relatedBy: .equal, toItem: self.view, attribute: .trailing, multiplier: 1.0, constant: -10))
        addUrlBtn.addConstraint(NSLayoutConstraint(item: addUrlBtn, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 58))
        addUrlBtn.addConstraint(NSLayoutConstraint(item: addUrlBtn, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 58))
        ...
        self.view.addConstraint(NSLayoutConstraint(item: searchBtn, attribute: .top, relatedBy: .equal, toItem: urlTblView, attribute: .bottom, multiplier: 1.0, constant: 10))
        self.view.addConstraint(NSLayoutConstraint(item: searchBtn, attribute: .leading, relatedBy: .equal, toItem: self.view, attribute: .leading, multiplier: 1.0, constant: 10))
        searchBtn.addConstraint(NSLayoutConstraint(item: searchBtn, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 100))
        searchBtn.addConstraint(NSLayoutConstraint(item: searchBtn, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 40))
        
        self.view.addConstraint(NSLayoutConstraint(item: addUrlBtn, attribute: .centerY, relatedBy: .equal, toItem: searchBtn, attribute: .centerY, multiplier: 1.0, constant: 0))
